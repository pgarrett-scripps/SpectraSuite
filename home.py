...
Also, since all DTASelect-filter.txt files share the same name it is good practice to rename it to match the project and/or search conditions.
for example ANL_project_XXXX_unmod_DTASelect-filter.txt or something similar.
